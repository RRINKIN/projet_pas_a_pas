        ...
        if(is_array($result)){
            foreach($result as $r){
                ...
                if($is_visible == "1"){
                    ...
                    $txt_delivery = "<s style='color:#b1b1b1;'>" .$delivery."</s>";
                    $txt_visible = "<i class=\"fas fa-eye\"></i>";
                    $txt_title = "Réactiver cette entrée";
                }

                echo "<p>
                        <a href='index.php?p=".$url_page."&delivery_id=".$id."&action=update&id=".$get_id."' title='éditer cette entrée' class='bt-action'><i class=\"far fa-edit\"></i></a> 
                        <a href='index.php?p=".$url_page."&delivery_id=".$id."&action=showHide&id=".$get_id."' title='".$txt_title."' class='bt-action'>".$txt_visible."</a> 
                        ".$txt_delivery." 
                    </p>";
            }
        }
